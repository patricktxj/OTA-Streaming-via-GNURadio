...
class TextStreaming(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "TextStreaming")
        ...
        self.RRC_filter_taps = RRC_filter_taps = firdes.root_raised_cosine(nfilts, nfilts,1.0, 350e-3, 5*40*32)
        ...
        self.digital_pfb_clock_sync_xxx_0_0 = digital.pfb_clock_sync_ccf(2, timing_loop_bw, RRC_filter_taps, nfilts, nfilts/2, 1.5, 2)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, 'C:\\Users\\patri\\Desktop\\test.txt', True, 0, 0)
...
def main(top_block_cls=TextStreaming, options=None):
